        ...
        <div className="space-y-6">
          {experiences.map((exp, index) => (
            <div key={index} className="relative pl-8 group">
              <div className="absolute left-0 top-2 w-4 h-4 rounded-full bg-white dark:bg-neutral-950 border-2 border-neutral-400 dark:border-neutral-600 transition-all duration-300 group-hover:border-blue-500 group-hover:scale-125 group-hover:shadow-lg group-hover:shadow-blue-500/20" />

              <div 
                className="bg-neutral-50 dark:bg-neutral-900 rounded-lg p-4 border border-neutral-200 dark:border-neutral-800 transition-all duration-300 hover:border-neutral-300 dark:hover:border-neutral-700 hover:shadow-lg cursor-pointer"
