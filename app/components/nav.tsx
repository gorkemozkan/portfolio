  ...
  return (
    <aside className="-ml-[8px] mb-16 tracking-tight">
      <div className="lg:sticky lg:top-20">
        ...
        >
          <div className="flex flex-row items-center gap-2" role="menubar">
            {Object.entries(navItems).map(([path, { name, icon }]) => {
              ...
              return (
                ...
                >
                  ...
                  <span className="relative z-10 text-neutral-600 dark:text-neutral-400 group-hover:text-neutral-900 dark:group-hover:text-neutral-100 transition-colors duration-300 transform   transition-transform">
                    {icon}
                  </span>
